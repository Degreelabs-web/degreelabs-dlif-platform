...
export interface Company {
  ...
  founder_sponsor?: string | null;
  founder_title?: string | null;
  public_journey_stages?: string[] | null;
  brand_colors?: {
    primary_red?: string;
  ...
  reference_challenge_areas?: string[] | null;
  status: string;
...
export interface Project {
  ...
  questions_to_investigate?: string[] | null;
  project_boundaries?: string[] | null;
  north_star_metric?: string | null;
  supporting_measures?: string[] | null;
  related_context_figures?: Record<string, string> | null;
  discover_timeline?: Record<string, { focus: string; output: string }> | null;
  gate_schedule?: Record<string, string> | null;
  company_challenge_owner?: string | null;
